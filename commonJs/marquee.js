...
**/
  ...
  function createMarquee(settings) {
      ...
      for (i = 0; i < spawnAmount; i++) {
          ...
          $(marqueeSpawned[i].name).css('margin-left', parseInt(marqueeSpawned[i].currentPos+config.padding) +'px'); //setting margin according to postition
  ...
  function marqueeManager(marqueed_el) {
        ...
        if (marqueed_el.hovered == false) { 
            ...
            if (marqueed_el.counter > 0) {  //this is not the first loop
                ...
                marqueed_el.el.css('margin-left', parseInt(marqueed_el.containerWidth) +'px'); //setting margin according to postition
