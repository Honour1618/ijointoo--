...
$(function(){
	...
	$("#btnLogin").bind("click" , function(e){
		...
		if(rspImgUri == "" && rspBussPPT == ""){//$("#userAvatar").val()   $("#plantBook").val()
	...
	$(".business_plan").click(function(){
		$(".business_plan_agreement").show();
		$(".container").css('height','1407px');
		$("table").hide();
		$(".close_plan").show().mouseenter(function(event) {
			$(".close_plan ").addClass("close_light");
		}).mouseleave(function(event) {
			$(".close_plan").removeClass("close_light");
		});
	});
