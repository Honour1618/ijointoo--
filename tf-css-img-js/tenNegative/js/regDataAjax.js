      ...
      success: function (msg){
    	  if(msg.dateMeeting == "dateMeet"){
    		  if(msg.result=='0' ){
    			  ...
    			  window.location.href = webroot + "/PtlTest!share.action?prjCode=" + msg.prjCode;
...
function wechatConfig(){
	var dataForWeixin={
		...
		imgUrl: commUrl + "/file/tf/tenNegative/img/share_ico.png",
		link:	commUrl + "/PtlMobile!negative.action#mainWrap",
		title:	shareTitle,
		desc:	shareDesc
	};
