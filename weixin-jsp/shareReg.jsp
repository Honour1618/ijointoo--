...
<div class="page_body reg_bg">
	<div style="position: relative;">
		...
		<div class="register">
			<form id="pform" action='<s:url value="/PtlWeixin!shareRegdo.action"/>' method="post">
				<div class="row">
				...
				<c:if test="${empty rcUserId  && rc == null}">
					<s:if test="#session.rf == null ">
					<div class="row mt_10">
						<div class="input-group">
							<span class="input-group-addon if_title_b">推荐人${sessionScop.rf}</span>
...
<!-- 
 ...
 -->
				...
				<div class="row mt_10">
					<input type="image" src="${ctx}/h5/img/btn_reg.png" width="300px"/>
				</div>
				<div class="row mt_10 txt_center">
					<div style="font-family: 微软雅黑;padding-bottom: 20px;">
						已注册账号？<a href="${ctx }/PtlWeixin!shareLogin.action" style="color: #2364D2;">登录</a>后推荐分享也有红包哟！
					</div>
				</div>
			</form>
		</div>
